<template>
    <v-app>
            ...
            >
                    ...
                    <v-btn v-if="1" icon nuxt to="/postindex" :style="{ marginLeft:'0px',paddingLeft:'0px', display:'flex', alignItems: 'center'}">
                    ...
                    <v-toolbar-title>
                        ...
                        <nuxt-link to="/"><h4>HIDDEN PORTAL</h4></nuxt-link>
            ...
            >
                ...
                <v-btn nuxt to="/signup" value="favorites" class="white">
